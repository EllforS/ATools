 ...
 * 2018/3/26 15:32
 */
public class ExBitmapCompressUtil
{
    /**
     * 压缩图片
     */
    ...
    {
        // 创建目录
        File imageDir = new File(ExFileUtil.getPath(ExFileUtil.FILE_IMAGE_SAVE_DIR));
    ...
    {
        File imageDir = new File(ExFileUtil.getPath(ExFileUtil.FILE_IMAGE_SAVE_DIR));
        ExFileUtil.deleteFilesRecursively(imageDir, true);
    }
