...
public class ExImageLoader
{
    ...
    private static final int IMG_DEF = R.drawable.default_img;
    private static final int IMG_FAIL = R.drawable.default_img_failed;
    private static final int DEFAULT_AVATAR = R.drawable.default_img_failed;
