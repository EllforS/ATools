...
{
    private static final String APP_FILES_DIR = "/EllforS";
    public static final String APK_NAME = "ellfors_release.apk";        //APK名称
    ...
    public static void openFile(Activity mContext, File file)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
        {
            ...
            Uri contentUri = FileProvider.getUriForFile(mContext, "com.kingstarit.tjxs_ent.fileProvider", file);
