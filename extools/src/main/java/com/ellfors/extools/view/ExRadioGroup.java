    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b)
    {
        ...
        for (int i = 0; i < getChildCount(); i++)
        {
            ...
            if (currentWidth + childWidth + childMarginLeft + childMarginRight > width - pl - pr)
            {
                ...
                currentWidth = pl;
                // 布局视图
                child.layout(currentWidth + childMarginLeft, currentHeight + childMarginTop, currentWidth + childMarginLeft + childWidth, currentHeight + childMarginTop + childHeight);
                currentWidth += childMarginLeft + childMarginRight + childWidth;
            }
            else
            {
